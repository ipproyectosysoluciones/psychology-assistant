  ...
  features = [
    {
      ...
      description:
        'Administra múltiples consultorio desde un solo lugar. Escalabilidad total para tu red de servicios psicológicos.',
    },
    {
      icon: 'groups',
      title: 'Directorio de Terapeutas',
      description:
        'Organiza tus profesionales, gestiona disponibilidad, y visualiza ocupación en tiempo real.',
    },
    {
      icon: 'description',
      title: 'Historiales Médicos Digitales',
      description:
        'Almacena seguro los registros de tus pacientes. Acceso rápido a diagnósticos y antecedentes clínicos.',
    },
    {
      icon: 'assignment',
      title: 'Reportes Clínicos Inteligentes',
      description:
        'Genera reportes detallados de progreso. Seguimiento automático de evolución del paciente.',
    },
    {
      icon: 'receipt',
      title: 'Sistema de Facturación Integrado',
      description:
        'Crea facturas, gestiona pagos, y sincroniza con tu sistema contable. Todo en un solo lugar.',
    },
    {
      icon: 'trending_up',
      title: 'Analíticas y Reportes',
      description:
        'Visualiza métricas de tu consultorio. KPIs, ocupación, ingresos y métricas de satisfacción.',
    },
  ];
